"""
Script to import poses from poses.yaml into the database.
Run this script to populate the database with initial pose data.

Usage:
    python -m scripts.import_poses
"""
import asyncio
import yaml
import sys
...
async def import_poses():
    ...
    async with AsyncSessionLocal() as session:
        ...
        if existing_count > 0:
            ...
            response = input("Do you want to clear and reimport all poses? (yes/no): ")
